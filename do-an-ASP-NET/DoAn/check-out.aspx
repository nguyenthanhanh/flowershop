<%@ Page Title="" Language="C#" MasterPageFile="~/Master-page-do-an.Master" AutoEventWireup="true" CodeBehind="check-out.aspx.cs" Inherits="DoAn.checkout" %>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Thanh Toán Các</a></span> <span>Sản Phẩm Của</span></p>
        ...
        <div class="row justify-content-center">
          <div class="col-xl-7 ftco-animate">
                ...
                <div class="w-100"></div>
		            <div class="col-md-12">
		            	<div class="form-group">
		            		<label for="country">Thành Phố / Quốc Gia</label>
		            ...
		            <div class="col-md-6">
		            	<div class="form-group">
	                  <input type="text" class="form-control" placeholder="Quận/Phường,Tỉnh/Huyện)">
	                </div>
		            </div>
		            <div class="w-100"></div>
		            <div class="col-md-6">
		            ...
		            <div class="col-md-6">
		            	<div class="form-group">
		            		<label for="postcodezip">Mã Bưu Điên *</label>
	                  <input type="text" class="form-control" placeholder="">
	                </div>
		            </div>
		            <div class="w-100"></div>
                ...
                <div class="col-md-12">
                	<div class="form-group mt-4">
										<div class="radio">
										  ...
										  <label><input type="radio" name="optradio"> Gửi Hàng Đến Dịa Chỉ Khác</label>
										</div>
									</div>
                </div>
	            </div>
	          ...
	          <div class="row mt-5 pt-3">
	          	<div class="col-md-12 d-flex mb-5">
	          		<div class="cart-detail cart-total p-3 p-md-4">
	          			<h3 class="billing-heading mb-4">Tổng Số Sản Phẩm</h3>
	          			<p class="d-flex">
		    						<span>Subtotal</span>
		    						<span>$20.60</span>
		    					</p>
